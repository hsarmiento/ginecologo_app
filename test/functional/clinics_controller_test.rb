...
class ClinicsControllerTest < ActionController::TestCase
  ...
  test "should create clinic" do
    assert_difference('Clinic.count') do
      post :create, clinic: { address: @clinic.address, city: @clinic.city, name: @clinic.name, phone: @clinic.phone }
    end
  ...
  test "should update clinic" do
    put :update, id: @clinic, clinic: { address: @clinic.address, city: @clinic.city, name: @clinic.name, phone: @clinic.phone }
    assert_redirected_to clinic_path(assigns(:clinic))
  end
